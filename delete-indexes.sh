...
curl -k -X DELETE -u admin  "https://localhost:9202/bbuy_products"
if [ $? -ne 0 ] ; then
...
curl -k -X DELETE -u admin  "https://localhost:9202/bbuy_queries"
if [ $? -ne 0 ] ; then
...
curl -k -X DELETE -u admin  "https://localhost:9202/bbuy_annotations"
